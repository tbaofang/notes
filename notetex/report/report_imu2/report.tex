...
\input{contents/01_IMU应用讲解计划.tex}
\input{contents/11_IMU误差模型.tex}
\input{contents/12_IMU确定性误差标定.tex}
\input{contents/13_IMU确定性误差标定2.tex}
\input{contents/21_IMU随机误差模型.tex}
\input{contents/22_IMU随机误差标定.tex}


\input{contents/reference.tex}

% \input{contents/21_IMU标定.tex}
% \input{contents/22_IMU测量模型.tex}
% \input{contents/31_IMU应用中的问题及解决.tex}
